...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
                            ...
                            <ul class="dropdown-menu mega-dropdown-menu-1 row">                           
                                <li class="col-sm-12">
                                    <form action="controlador_registrar.php" class="form-inline" role="form" METHOD="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="ci" class="col-sm-10 text-danger">N° DE MATERIAS</label>
                                            <div class="col-lg-12">                                                       
        ...
        <?php
            ...
            echo $cantidad;            
        ?>
        <form action="controlador_materia.php" class="form-inline" METHOD="POST">
        ...
        <div align="center">
            <table border="1">
                ...
                for ($i=0; $i < $cantidad; $i++) {  
                    ...
                    $codigo="codigo".$j;                    
                    echo "<tr>";
                    echo "<td><input type = 'text' name='$materia' value='$modulo' readonly/></td>";                                                
                    echo "<td><input type = 'text' name='$materia' required/></td>";                                                
                    echo "<td><input type = 'text' name='$codigo' required/></td>";
                    echo "</tr>";
                    $j++;
                    }
                ?>
