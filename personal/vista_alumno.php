...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="nav navbar-nav">
                        <li class="dropdown mega-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">REGISTRAR INSTRUCTOR<span class="caret"></span></a>
                        ...
                        <li class="dropdown mega-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">MODIFICAR<span class="caret"></span></a>
                        ...
                        <li class="dropdown mega-dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">REGISTRAR ALUMNO<span class="caret"></span></a>
                                ...
                                <li class="col-sm-12">
                                    <form action="controlador_registrar_alumno.php" class="form-inline" role="form" METHOD="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="ci" class="col-sm-12 text-danger">GRADO</label>
                                            <div class="col-lg-12">
                                                <input type="text" name="grado" class="form-control" list="grado_al" required/>                                                
                                        ...
                                        <div class="form-group">
                                            <label for="arma" class="col-sm-12 text-danger">ARMA</label>
                                            <div class="col-lg-12">                                                
                                                <input type="text" name="arma" class="form-control" list="arma_al" required/>                                                
                                                <datalist id="arma_al">
                                                    <option value="INF"> 
                                                    <option value="CAB">    
                                                    <option value="ART">    
                                                    ...
                                                    <option value="TRANS">
                                                    <option value="SAN">
                                                    <option value="MEC ARM">
                                                    <option value="MEC AVI">                             
                                                </datalist>
                                            </div>                                       
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="lugar" class="col-sm-12 text-danger">SEXO</label>
                                            <div class="col-lg-12">                                                
                                                    <input type="text" name="sexo" class="form-control" list="sexo" required/>                                                
                                                    <datalist id="sexo">
        ...
        <?php
            ...
            $result1 = mysqli_query($conexion, "SELECT * FROM alumno_militar WHERE ci = '".$ci."' ");
            $row1 = mysqli_fetch_array($result1);
        ?>
        <form action="modificar_alumno.php" class="form-inline" METHOD="POST">
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="arma">SEXO</label>                                                                                            
                <input type="text" name="sexo" class="form-control" value="<?php echo $row['sexo'];?>" requiered/>                                            
            </div>
            <div class="form-group">
